/**
 * SOVEREIGN WINDOW SCHEMA
 * Canonical states and transition rules for the sovereign temporal witness.
 */

export const WINDOW_STATES = Object.freeze({
    IDLE: "idle",               // No observation active
    PRIMED: "primed",           // Ritual entered, awaiting initial evidence
    OPEN: "open",               // Window instantiated (momentary)
    ACTIVE: "active",           // Sovereign observation in progress
    ...
    CLOSED_INVALID: "closed_invalid", // Sovereignty-unfit closure
