...
import { SovereignUXKernel } from '../kernel/SovereignUXKernel';

/**
 * RITUAL GATE
 * High-priority UI layer that blocks experience access until ritual completion.
 * Driven by SovereignUXKernel.requireDailyRitual().
 */
export const RitualGate = ({ snapshot, children }) => {
    const ritual = SovereignUXKernel.requireDailyRitual(snapshot);
